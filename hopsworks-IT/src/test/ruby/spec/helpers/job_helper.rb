    ...
    if type.eql? "jar"
      if job_conf.nil?
        job_conf = {
            ...
            "amVCores": 1,
            "jobType": "SPARK",
            "appPath": "/Projects/#{project[:projectname]}/TestJob/spark-examples.jar",
      ...
      if job_conf.nil?
        job_conf = {
            ...
            "amVCores": 1,
            "jobType": "PYSPARK",
            "appPath": "/Projects/#{project[:projectname]}/Resources/" + job_name + ".py",
      ...
      expect_status(201)
        ...
        job_conf = {
          ...
          "amVCores":1,
          "jobType":"PYSPARK",
          "appPath":"/Projects/#{project[:projectname]}/Resources/" + job_name + ".ipynb",
          "mainClass":"org.apache.spark.deploy.PythonRunner",
          "args":"10",
          "spark.executor.instances":1,
          "spark.executor.cores":1,
